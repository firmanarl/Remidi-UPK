                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">TanggalPen jualan</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo "<a href='editpenjualan.php?id=$row[PenjualanID]'> UPDATE </a> | <a href='deletepenjualan.php?id=$row[PenjualanID]'> DELETE </a>"; ?>
                                </td>
                            </tr>
                            <?php 
                }
                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo "<a href='editproduk.php?id=$row[ProdukID]'> UPDATE </a> | <a href='deleteproduk.php?id=$row[ProdukID]'> DELETE </a>"; ?>
                                </td>
                            </tr>
                            <?php 
                            }
