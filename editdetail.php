...
<body>
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Update Detail Penjualan</h5>
                    ...
                    ?>
                    <?php
                    $tampil=mysqli_query($koneksi,"select * from detail_penjualan where DetailID='$_GET[id]'");
                    foreach ($tampil as $row){
                    ?>
                    <form method="POST" action="">
                        <div class="form-grup">
                            <label><b>Detail ID</b></label>
                            <input type="text" name="DetailID" value="<?php echo $row['DetailID'];?>"
                                class="form-control" placeholder="Masukkan ID Detail">
                        </div>
                        <br>
                        <div class="form-grup">
                        ...
                        <div class="form-grup">
                            ...
                            <input type="text" name="ProdukID" value="<?php echo $row['ProdukID'];?>"
                                class="form-control" placeholder="Masukkan ID Produk">
                        </div>
                        <br>
                        <div class="form-grup">
                            <label><b>Jumlah Produk</b></label>
                            <input type="text" name="JumlahProduk" value="<?php echo $row['JumlahProduk'];?>"
                                class="form-control" placeholder="Masukkan Jumlah Produk">
                        </div>
                        <br>
                        <div class="form-grup">
                            <label><b>SUB Total</b></label>
                            <input type="text" name="SubTotal" value="<?php echo $row['SubTotal'];?>"
                                class="form-control" placeholder="Masukkan SubTotal">
                        </div>
                        <br>
